...
class PageController < ApplicationController
  anon_actions = [
    ...
    :circles_validation,
    :primarias_andalucia,
    :listas_primarias_andaluzas,
    :responsables_organizacion_municipales,
    :responsables_municipales_andalucia,
    :plaza_podemos_municipal,
    :portal_transparencia_cc_estatal,
    :mujer_igualdad,
    :alta_consulta_ciudadana,
    :representantes_electorales_extranjeros,
    :responsables_areas_cc_autonomicos,
    :apoderados_campana_autonomica_andalucia, :comparte_cambio_valoracion_propietarios,
    :comparte_cambio_valoracion_usuarios,
    :avales_candidaturas_primarias,
    :iniciativa_ciudadana,
    :privacy_policy,
    :faq
  ]
  before_action :authenticate_user!, except: anon_actions
